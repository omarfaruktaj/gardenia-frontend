    ...
    <div className="flex flex-col">
      {value ? (
        ...
        <label
          ...
          className={`flex items-center  w-24 h-24 justify-center mt-2 rounded-lg transition-colors border border-dashed border-primary ${disabled || isUploading ? 'cursor-not-allowed opacity-50' : ''}`}
        >
